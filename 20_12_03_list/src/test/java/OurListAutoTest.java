...
public abstract class OurListAutoTest {
    ...
    public void testForwardIterator_HasNextAndNextWorkCorrectly(){
        ...
        Iterator<Auto> iterator = autos.forwardIterator();
    ...
    public void testReverseIterator_HasNextAndNextWorkCorrectly(){
        ...
        Iterator<Auto> iterator = autos.reversedIterator();
    ...
    public void testReverseIteratorCurrentIndexLessThanZero_NullPointerException(){
        ...
        while (iterator.hasNext()){
            ...
            Auto iterAuto = iterator.next();
            Assertions.assertEquals(auto, iterAuto);
        }
    ...
    @Test
    public void testCombinedAddLastRemoveGetSet(){
        ...
        Assertions.assertEquals(autos.get(0).brand, "Mazda");
        Assertions.assertEquals(autos.get(1).brand, "Lada");
